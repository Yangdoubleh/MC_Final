<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8" import="com.example.demo.vo.MemberMenuVO" %>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
...
<body>
	...
	<form action="replyWriteForm" method="post">
		...
		<table class="table table-border">
			...
			<tr><td>글내용</td><td><textarea rows="8" cols="25" readonly style="background:lightgray">${article.content }</textarea></td></tr>
			<tr><td>첨부된 파일</td><td><img src="uploadImg/${article.fileName }" height="50"></td></tr>
		</table>
		<center>
			<input type="submit" value="답글쓰기" class="btn btn-info" >
			&nbsp; &nbsp; <p class="btn btn-info" onclick="history.back()">글 목록으로 </p>
